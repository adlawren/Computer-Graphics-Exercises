...
Texture::Texture(char *fileName, bool texture_is_alpha_blended, bool clamp_u,
                 bool clamp_v) {
...
void Texture::bindTexture() {
  if (bTextureNeedsToBeStreamedIn)
    loadTexture();
  if (bTextureLoaded)
...
bool Texture::isAlphaBlended() { return bTextureIsAlphaBlended; }
